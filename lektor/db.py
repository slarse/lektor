...
from lektor._compat import string_types, text_type, integer_types, iteritems, range_type
from lektor import metaformat
from lektor.utils import (
...
class _CmpHelper(object):
    ...
    @staticmethod
    def _is_numeric_instance(a):
        return isinstance(a, integer_types) or isinstance(a, float)

    @staticmethod
    def _numeric(a, b):
        with _error():
            if _CmpHelper._is_numeric_instance(a):
                return a, type(a)(b)
            if _CmpHelper._is_numeric_instance(b):
                return type(b)(a), b
        return a, b
    ...
    def coerce(a, b):
        ...
        if isinstance(a, Undefined) or isinstance(b, Undefined):
            return _CmpHelper._undefined(a, b)
        return _CmpHelper._numeric(a, b)
